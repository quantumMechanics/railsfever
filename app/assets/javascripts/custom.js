    ...
    $( "#dialog-form-disconnected" ).dialog({
      ...
      buttons: {
        "Send": function() {
          ...
          bValid = bValid && checkLength( name, "name", 3, 36 );
          bValid = bValid && checkLength( email, "email", 6, 80 );
          bValid = bValid && checkLength( subject, "subject", 3, 36 );
          bValid = bValid && checkLength( message, "message", 10, 600);
          ...
          //TODO: ADD VALIDATION FOR MESSAGE.
          	...
          	/*
			ACTION TO TAKE IF THE CONTENT IS VALID	
